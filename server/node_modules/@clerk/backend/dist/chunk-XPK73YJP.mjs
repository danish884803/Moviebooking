...
var API_VERSION = "v1";
var USER_AGENT = `${"@clerk/backend"}@${"2.4.3"}`;
...
// src/api/endpoints/MachineTokensApi.ts
...
// src/api/resources/MachineToken.ts
    ...
    try {
      if (formData) {
        ...
        const buildBody = () => {
          ...
          const formatKeys = (object) => snakecaseKeys(object, { deep: false });
          return {
...
//# sourceMappingURL=chunk-XPK73YJP.mjs.map